...
public class ContentService {
    ...
    public Content get(Long id) {
        return contentRepository.findContentByIdAndContentStatus(id, ContentStatus.ACHIVED).orElseThrow(() -> new ContentNotFoundException(id));
    }

    @Transactional(readOnly = true)
    public Content view(Long id) {
        return contentRepository.findContentByIdAndContentStatus(id, Arrays.asList(ContentStatus.PUBLISHED, ContentStatus.CHANGED)).orElseThrow(() -> new ContentNotFoundException(id));
    }
    ...
    public Content edit(Long id, EditContentCommand editContentCommand) {
        ...
        Content content = contentRepository.findContentByIdAndContentStatus(id, ContentStatus.ACHIVED).orElseThrow(() -> new ContentNotFoundException(id));
    ...
    public Page<Content> getAll(Pageable pageable) {
        return contentRepository.findContentPageByContentStatus(pageable, ContentStatus.ACHIVED);
    }
